    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-8 col-sm-8 col-sm-offset-2 text-center">
                ...
                <img class="img-responsive text-center cover-logo" src="https://s3-us-west-2.amazonaws.com/aoe-uploads/images/Hire%20P2%20logo.png">
            </div>
        </div>
        <!--Candidate-->
        <div class="row">
...
<div class="page-container" id="7">
    <div class="img-container-1">
        <img src="https://s3-us-west-2.amazonaws.com/aoe-uploads/images/Hire%20P2%20logo.png">
        <small>Page 2</small>
    </div>
    <div class="container">
        <!--Heading-->
