...
<head>
    ...
    <style>
        ...
        @media screen and (max-width:867px){
            ...
            .img-container-1 img, .img-container-2 img {display:none;}
            .report-logo {display:inline;}
        ...
        /* Adjust print styles */
        @media print {
            .cover-logo {padding-bottom:0px; padding-top:0px; max-width: 100%;}
...
<?php
    $page = 1;
    $logo = 'https://s3-us-west-2.amazonaws.com/aoe-uploads/images/Hire%20P2%20logo.png';
?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-8 col-sm-8 col-sm-offset-2 text-center">
                ...
                <img class="img-responsive text-center cover-logo" src="{{ $logo }}">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-10">
                <h5>Overview</h5>
                <p>
                    This report provides a recommendation for {{ $user->name }}, who applied for a {{ $job->name }} position. This report covers {{ $job->name }} personality and provides
...
{{-- Sub-Dimension Scores Continued --}}
<?php $page++; ?>
<div class="page-container" id="{{ $page }}">
    <div class="img-container-2">
        <img src="{{ $logo }}">
...
{{-- Sub-Dimension Scores Continued Again --}}
<?php $page++; ?>
<div class="page-container" id="{{ $page }}">
    <div class="img-container-1">
        <img src="{{ $logo }}">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="model-confidence" style="text-align:center;">
                    ...
                    <h4 style="display:inline-block;font-size:23px;">{{ $confidence }}</h4>
                </div>
            </div>
        </div>
    </div>
