        ...
        <div class="row">
            <div class="col-sm-10">
                ...
                <p>
                    ...
                    This report covers {{ $job->name }} personality, safety, and working memory, which focuses on memory,
                    attention, and information processing. This report provides evidence for the candidate's likelihood of
                    success in {{ $job->name }} related positions.
                </p>
            </div>
        </div>
