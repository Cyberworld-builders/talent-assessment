        ...
        <div class="row">
            <div class="col-sm-10">
                ...
                <p>
                    ...
                    This report covers {{ $job->name }} reasoning, personality, and safety. This report provides evidence
                    for the candidate's likelihood of success in {{ $job->name }} related positions.
                </p>
            </div>
        </div>
            ...
            <div class="col-sm-12 ">
                <div class="row">
                    ...
                    <div class="col-xs-4 col-sm-4 col-sm-offset-4">
                        <img class="img-responsive " src="{{ $baseUri }}/assets/images/involved-talent-assessment.png">
                    </div>
                </div>
        ...
        <div class="row text-center">
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-xs-4 col-sm-4 col-sm-offset-4">
                        <img class="img-responsive" src="{{ $baseUri }}/assets/images/involved-talent-s.png">
                    </div>
                </div>
            </div>
            <div class="col-sm-12 text-justify">
        ...
        <div class="row text-center">
            <div class="col-sm-12 ">
                <div class="row">
                    <div class="col-xs-4 visible-xs"></div>
                    <div class="col-xs-4 col-sm-4 col-sm-offset-4">
                        <img class="img-responsive " src="{{ $baseUri }}/assets/images/AOE-S.png">
                    </div>
                </div>
                <h1>Scoring and Importance</h1>
