    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-10">
                ...
                <p>This report provides a recommendation for {{ $user->name }}.</p>
            </div>
        </div>
...
{{-- Personality Scoring and Importance --}}
{!! $page++ !!}
<div class="page-container" id="{{ $page }}">
...
{{-- Personality Dimension Breakdown 1 --}}
{!! $page++ !!}
<div class="page-container" id="{{ $page }}">
    <div class="img-container-1">
        <img src="/wp/wp-content/themes/aoe/images/aoe-science_logo.png">
...
{{-- Personality Dimension Breakdown 2 --}}
{!! $page++ !!}
<div class="page-container" id="{{ $page }}">
    <div class="img-container-2">
        <img src="/wp/wp-content/themes/aoe/images/aoe-science_logo.png">
...
{{-- Personality Dimension Breakdown 3 --}}
{!! $page++ !!}
<div class="page-container" id="{{ $page }}">
    <div class="img-container-1">
        <img src="/wp/wp-content/themes/aoe/images/aoe-science_logo.png">
