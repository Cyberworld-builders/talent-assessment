...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .cover-logo {padding-bottom:0px; padding-top:0px;}
...
//                        {value: 50, color:'#30BD21'}
            ...
            $('#chart5').highcharts({
                ...
                subtitle: {
                    ...
                    text: 'Not Recommended',
                    @elseif ($scores['WM']['Division'] == 3)
                    text: 'Caution',
                    @elseif ($scores['WM']['Division'] == 1)
                    text: 'Pursue',
                    @endif
                    floating: true,
                    align: 'left',
...
//                        {value: 33, color:'#E7B428'},
//                        {value: 50, color:'#30BD21'}
                        @foreach($scores['WM']['Zones']['value'] as $i => $zoneValue)
                        <?php
                        $value = $scores['WM']['Zones']['value'][$i];
                        $color = $scores['WM']['Zones']['color'][$i];
                        echo '{value: '.$value.', color:"'.$color.'"},';
                        ?>
                        @endforeach
                    ],
        ...
        <div class="row">
            <div class="col-sm-10">
                ...
                <p>
                    ...
                    This report covers {{ $job->name }} reasoning, personality, safety, and working memory, which
                    focuses on memory, attention, and information processing. This report provides evidence for the candidate's
                    likelihood of success in {{ $job->name }} related positions.
                </p>
            </div>
        </div>
...
{{--<div class="page-container" id="2">--}}
    ...
    {{--<div class="container">--}}
        ...
        {{--<div class="row">--}}
            ...
            {{--</div>--}}
            {{--<div class="col-xs-9 col-sm-10 text-left">--}}
                {{--<h3>Cognitive Ability Fit Indicator</h3>--}}
            {{--</div>--}}
            {{--<div class="col-xs-3 col-sm-2 text-right">--}}
    ...
    <div class="container">
        ...
        <div class="row text-center">
            <div class="col-sm-12">
                ...
                <div class="col-xs-2"></div>
                {{--<div class="col-xs-8">--}}
                {{--<img class="img-responsive" src="/assets/images/gauge.png">--}}
                {{--</div>--}}
                <div class="col-xs-8">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            @if ($scores['WM']['Division'] == 5)
                ...
                <!-- Not Recommended Feedback -->
                    <p>The score suggests that {{ $user->name }} is relatively weak at multi-tasking, decision-making, problem-solving, and critical thinking.</p>

            @elseif ($scores['WM']['Division'] == 3)

                <!-- Caution Feedback -->
                    <p>The score suggests that {{ $user->name }} is moderately adequate at multi-tasking, decision-making, problem-solving, and critical thinking.</p>

            @elseif ($scores['WM']['Division'] == 1)

                <!-- Pursue Feedback -->
                    <p>The score suggests that {{ $user->name }} is strong at multi-tasking, decision-making, problem-solving, and critical thinking.</p>
