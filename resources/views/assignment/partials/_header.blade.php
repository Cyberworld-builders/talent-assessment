@if (!$task)
    <div class="heading">
        ...
        @else
            <img class="background" src="{{ show_image($assessment->background) }}" onerror="this.src='{{ asset('images/background.jpg') }}'" />
        @endif
        ...
        <div class="logo">
            ...
            @else
                <img style="height: 100%;" src="{{ $assessment->logo }}" onerror="this.src='{{ asset('images/logo.png') }}'" />
            @endif
        </div>
