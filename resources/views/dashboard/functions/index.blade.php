                ...
                <div class="tab-pane active">
                    ...
                    <table class="table table-hover members-table middle-align">
                        ...
                        <tr style="background-color:white;margin-top:2px;">
                            ...
                            {{--</td>--}}
                            <td>
                                <a href="{{ url('dashboard/weighting/1/functions/1/edit') }}"><i class="fa-edit"></i> Edit</a><br/>
                        ...
                        <tr style="background-color:white;margin-top:2px;">
                            ...
                            {{-- Assignment --}}
                            <td class="user-name">
                                <a href="#" class="name">DCS Operator</a>
                            </td>
                            <td class="user-name">
                                <div class="label label-white label-dimension">Honesty <span class="percentile pull-right">0.21</span></div>
                                <div class="label label-white label-dimension">Emotional Control <span class="percentile pull-right">0.07</span></div>
                    ...
                    {{--</div>--}}
                    <a href="{{ url('dashboard/weighting/1/functions/1/edit') }}" class="btn btn-black">Add Function</a>
                    {{--@endif--}}
