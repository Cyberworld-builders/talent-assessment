...
<div class="page-title">
    <div class="title-env">
        <h1 class="title">{{ $client->name }}: Edit {{ $report->name }}</h1>
        <p class="description">Edit the job {{ $report->name }} for this client.</p>
    </div>
</div>
...
<div class="row">
    ...
    {!! Form::model($report, ['method' => 'PATCH', 'enctype' => 'multipart/form-data', 'action' => ['ReportsController@updateModeling', $client->id, $report->id], 'id' => 'form']) !!}
    @include('dashboard.reports.partials._modeling_form', [
        'edit' => true,
