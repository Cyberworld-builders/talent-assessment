...
@section('content')
    ...
    <div class="page-title">
        <div class="title-env">
            <h1 class="title">{{ $assessment->name }}: Assign</h1>
    ...
    <div class="row">
        ...
        <!-- Sub Navigation -->
        @include('dashboard.assessments.partials._subnav', ['active' => 'Assign'])

        <!-- Assignments -->
        {!! Form::open(['url' => 'dashboard/assessments/'.$assessment->id.'/assign']) !!}
            @include('dashboard.assessments.partials._assignform')
        {!! Form::close() !!}
