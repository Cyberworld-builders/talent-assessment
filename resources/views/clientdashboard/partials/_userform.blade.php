        ...
        <div class="member-form-inputs">
            ...
            <div class="row">
                ...
                @else
                    ...
                    <div class="col-sm-4">
                        <a id="generate-new-password" class="btn btn-black" style="margin: 0px; padding: 12px 20px;">Set New Password</a>
                    </div>
                @endif
            </div>
    ...
    jQuery(document).ready(function($){
        ...
        $('#generate-new-password').on('click', function(){
            if (! $('#password').hasClass('active')) {
                ...
                $(this).removeClass('btn-white').addClass('btn-black').html('Set New Password');
            }
        });
