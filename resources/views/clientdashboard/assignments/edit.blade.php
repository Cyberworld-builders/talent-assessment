    ...
    <div class="content">
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="title-env">
                        <h1>Assignment: {{ $assessment->name }}</h1>
                        <p>Edit this assignment's details for the user {{ $user->name }}.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                {{-- Back Button --}}
                <div class="col-md-12">
                    <a href="{{ url('dashboard/all-users/'.$user->id) }}" class="btn btn-black"><i class="fa-chevron-left"></i> Go Back</a>
                    <br/><br/>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    {!! Form::model($assignment, ['method' => 'PATCH', 'action' => ['AssignmentsController@update', $assignment->id]]) !!}
                        @include('dashboard.assignments.partials._assignform', ['edit' => true, 'buttonName' => 'Update'])
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
