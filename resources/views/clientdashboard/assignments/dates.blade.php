        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="title-env">
                        <h1>Assignments</h1>
                        <p>View and manage all assigned assessments for all applicants across all jobs.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="pull-right">
                        ...
                        {{--<a href="{{ url('dashboard/assignments/bulk-edit') }}" class="btn btn-black"><i class="linecons-pencil"></i> Bulk Edit Assignments</a>--}}
                        <div class="btn-group">
                            <button type="button" class="btn btn-black dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                <i class="linecons-pencil"></i> Bulk Edit Assignments <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu dropdown-black" role="menu">
                                @foreach ($client->jobs as $job)
                                    <li>
                                        <a href="{{ url('dashboard/assignments/jobs/'.$job->id.'/bulk-edit') }}">For {{ $job->name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
