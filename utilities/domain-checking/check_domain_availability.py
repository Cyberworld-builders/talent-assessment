...
def check_domain_availability(domains: List[str]) -> Dict[str, str]:
    """
    Check availability for multiple domains using AWS Route 53 Domains
    """
    ...
    for domain in domains:
        try:
            ...
            print(f"❌ {domain}: Error checking availability")
