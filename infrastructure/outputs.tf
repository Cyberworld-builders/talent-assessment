...
output "rds_port" {
  ...
  value       = aws_db_instance.talent_assessment_db.port
}

output "rds_database_name" {
  description = "RDS database name"
  value       = aws_db_instance.talent_assessment_db.db_name
}
...
output "alb_zone_id" {
  ...
  value       = aws_lb.talent_assessment_alb.zone_id
}
...
output "target_group_arn" {
  ...
  value       = aws_lb_target_group.talent_assessment_tg.arn
}
